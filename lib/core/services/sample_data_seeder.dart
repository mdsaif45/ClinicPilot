...
class SampleDataSeeder {
  static Future<void> seedRealisticData(WidgetRef ref) async {
    ...
    final masterRecord = MasterCaseRecordData(
      ...
      hpi: 'Pain began gradually 2 years ago. Worsens during winter and damp weather. Known Type 2 Diabetes for 6 years.',
      pastHistory: 'Surgically drained ischiorectal abscess 5 years ago. Measles in childhood.',
      familyHistory: 'Father: Type 2 Diabetes & Hypertension. Mother: Osteoarthritis.',
      developmentalHistory: 'Normal full-term delivery. Normal developmental milestones.',
      physicalGenerals: const PhysicalGenerals(
        thermal: 'Hot (Warm blooded)',
        weatherPreference: 'Dislikes cold damp weather, prefers dry weather',
        thirst: 'Thirsty for large quantities of normal water',
        appetite: 'Good, irritable if meals are delayed',
        cravings: 'Sweets, warm tea, fresh fish, sour fruits',
        aversions: 'Boiled milk, fatty greasy mutton',
        intolerances: 'Cabbage and onions cause bloating',
        stool: 'Regular but sluggish, prone to hemorrhoids',
        urine: 'Normal color, increased frequency at night',
        perspiration: 'Profuse and offensive, especially on forehead',
        sleep: 'Restless due to flatulence and joint ache',
        dreams: 'Dreams of falling, daily work routines',
      ),
      mentalGenerals: const MentalGenerals(
        ...
        companyDesireSolitude: 'Prefers quiet solitude when in pain',
        memoryConcentration: 'Good memory, sharp focus',
        stressResponse: 'Manifests in gastrointestinal bloating and headache',
      ),
      lifestyleHabits: 'Non-smoker, drinks 3 cups of tea daily. Moderate physical activity in tailoring shop.',
      clinicalExam: const ClinicalExamVitals(
        ...
        temperature: '98.4 F',
        spo2: '98%',
        pallorIcterus: 'No pallor, no icterus, no clubbing',
      ...
      miasmaticAnalysis: const MiasmaticAnalysis(
        ...
        syphiliticFeatures: 'Past history of abscess',
      ...
      baselinePrescription: 'Thuja Occidentalis 200C - 4 globules in morning on empty tongue for 3 consecutive days.',
      investigations: 'FBS, PPBS, HbA1c, Serum Uric Acid, X-Ray Right Hip & Knee.',
    ...
    await db.into(db.patientCaseRecords).insertOnConflictUpdate(
          PatientCaseRecordsCompanion.insert(
            ...
            hpi: Value(masterRecord.hpi),
            pastHistoryJson: Value(masterRecord.pastHistory),
            familyHistoryJson: Value(masterRecord.familyHistory),
            developmentalHistoryJson: Value(masterRecord.developmentalHistory),
            physicalGeneralsJson: Value(masterRecord.physicalGeneralsJson),
            mentalGeneralsJson: Value(masterRecord.mentalGeneralsJson),
            lifestyleJson: Value(masterRecord.lifestyleHabits),
            ...
            baselinePrescriptionJson: Value(masterRecord.baselinePrescription),
            investigationsJson: Value(masterRecord.investigations),
