...
class DemoArchetypes {
  static const List<DiseaseArchetype> all = [
    ...
    DiseaseArchetype(
      ...
      chiefComplaint: 'Severe aching pain and stiffness in bilateral knee joints with cracking sounds on walking.',
      ...
      aggravatingFactors: '< First movement, < Cold damp weather, < Prolonged sitting, < Ascending stairs',
      amelioratingFactors: '> Continued gentle walking, > Warm fomentation, > Dry warm weather',
      ...
      sleep: 'Restless sleep due to joint discomfort, frequent position changes',
      mentalGenerals: 'Mild, weeping disposition, anxious about mobility and independence',
      ...
      dietaryAdvice: 'Avoid sour foods, curds at night, and cold drinks. Daily gentle knee quadriceps exercises.',
      medicineFee: 350.0,
      ...
      testNotes: 'Confirmed degenerative osteoarthritis with mild subchondral sclerosis.',
    ),

    // 2. Allergic Rhinitis / Dust Allergy
    DiseaseArchetype(
      primaryDisease: 'Allergic Rhinitis / Dust Allergy',
      chiefComplaint: 'Paroxysmal sneezing (15-20 bouts) every morning with watery rhinorrhea and itchy palate.',
      location: 'Nose, eyes, and nasopharynx',
      side: 'Bilateral',
      onset: 'Sudden upon waking up',
      duration: '5 years chronic',
      sensation: 'Tickling in nostrils, burning watery discharge causing redness of upper lip',
      aggravatingFactors: '< Dust exposure, < Morning draft of air, < Cold AC air, < Sweeping house',
      amelioratingFactors: '> Warm room, > Hot tea/steam inhalation, > Sun exposure',
      concomitants: 'Lachrymation, mild frontal headache, and dark circles under eyes',
      ...
      mentalGenerals: 'Fastidious, neat and tidy, anxious regarding health and cleanliness',
      ...
      dietaryAdvice: 'Avoid refrigerated items, ice creams, and aerated drinks. Use dust covers on pillows.',
      medicineFee: 280.0,
    ...
    DiseaseArchetype(
      ...
      chiefComplaint: 'Unilateral right-sided throbbing, bursting headache starting over eye and extending to occiput.',
      ...
      sensation: 'Hammering, pulsating pain as if thousand hammers beating inside head',
      aggravatingFactors: '< Sun exposure, < Bright light, < Noise, < Mental exertion, < Skipping meals',
      amelioratingFactors: '> Lying in dark quiet room, > Hard pressure, > Sleep, > Cold compress',
      ...
      periodicity: 'Increases with sunrise, peaks at 12-1 PM, subsides at sunset',
      initialSeverity: 9,
      ...
      mentalGenerals: 'Introverted, reserved, grieves silently, < from consolation',
      miasm: 'Psoric',
      ...
      frequency: 'BD (Twice daily)',
      vehicle: 'Sugar globules No. 30',
      instructions: 'Take 4 pills early morning empty stomach and night before bed.',
      dietaryAdvice: 'Maintain regular meal timings. Avoid aged cheese, dark chocolates, and prolonged screen strain.',
      medicineFee: 320.0,
      testCategory: 'Imaging / Radiology',
      testName: 'Brain MRI (Plain)',
      stringValue: 'Normal brain parenchyma, no intracranial mass or vascular malformation',
      flag: 'Normal',
      labName: 'Peerless Hospital & Diagnostics',
      testNotes: 'Rule out secondary intracranial pathology. Consistent with classic migraine.',
    ),

    // 4. Polycystic Ovarian Disease (PCOD)
    DiseaseArchetype(
      primaryDisease: 'Polycystic Ovarian Disease (PCOD)',
      chiefComplaint: 'Irregular delayed menses (cycle 45-60 days), scanty flow, acne breakouts on chin and hirsutism.',
      ...
      aggravatingFactors: '< Warm room, < Fatty foods, < Emotional stress, < Wet feet',
      amelioratingFactors: '> Open cool fresh air, > Gentle walking, > Consolation',
      concomitants: 'Sudden weight gain (8 kg in 6 months), facial hair growth, mood swings',
      ...
      appetite: 'Aversion to fats and butter, craves pastries and sweet desserts',
      sleep: 'Sleeps late, dreams of falling',
      mentalGenerals: 'Gentle, yielding disposition, weeps easily while narrating complaints, seeks reassurance',
      miasm: 'Sycotic',
      ...
      dietaryAdvice: 'Low glycemic index diet. Daily 45 minutes brisk walking. Eliminate refined sugars and dairy.',
      medicineFee: 400.0,
      testCategory: 'Imaging / Radiology',
      testName: 'Pelvic Ultrasound (USG)',
      stringValue: 'Bilateral ovaries enlarged with multiple peripheral follicles (>12) and increased stromal echogenicity',
      flag: 'Abnormal',
      labName: 'Pulse Diagnostics Lab',
      testNotes: 'Classic ultrasound appearance of bilateral polycystic ovarian morphology.',
    ),

    // 5. Hypothyroidism & Weight Gain
    DiseaseArchetype(
      primaryDisease: 'Hypothyroidism & Weight Gain',
      chiefComplaint: 'Generalized sluggishness, chronic fatigue, cold intolerance, constipation, and unexplained weight gain.',
      ...
      concomitants: 'Dry scaly skin, diffuse hair thinning, puffy face around eyes in morning',
      ...
      dietaryAdvice: 'Include selenium-rich foods, iodized salt in moderation. Avoid raw cabbage, cauliflower, and soy.',
      medicineFee: 380.0,
      testCategory: 'Blood / Biochemistry',
    ...
    DiseaseArchetype(
      ...
      chiefComplaint: 'Fluctuating high blood pressure (155/95 mmHg) with occipital heaviness and flushing of face.',
      location: 'Cardiovascular system / Occiput',
      side: 'Central',
      onset: 'Insidious over 3 years',
      duration: '3 years',
      sensation: 'Throbbing pulsation in temples and neck arteries with mild dizziness',
      aggravatingFactors: '< Mental stress, < Physical exertion, < High salt intake, < Sleeplessness',
      amelioratingFactors: '> Quiet rest in semi-reclined position, > Fresh cool breeze',
      concomitants: 'Occasional palpitation on climbing stairs, tinnitus in left ear',
      causation: 'High-stress corporate job, family history of coronary disease',
      ...
      mentalGenerals: 'Ambitious, type-A personality, impatient, quick-tempered',
      ...
      instructions: 'Take 12 drops in half cup of plain water twice daily after food.',
      dietaryAdvice: 'Strict low sodium (<2g/day) DASH diet. Daily 30 mins aerobic walking. Practice deep breathing.',
      medicineFee: 420.0,
      testCategory: 'Blood / Biochemistry',
      ...
      flag: 'High',
      labName: 'Apollo Diagnostics Centre',
      testNotes: 'Hypercholesterolemia with elevated LDL (158 mg/dL) and borderline triglycerides (190 mg/dL).',
    ),

    // 7. GERD / Acid Peptic Disorder
    DiseaseArchetype(
      primaryDisease: 'GERD / Acid Peptic Disorder',
      chiefComplaint: 'Retro-sternal burning heart-burn, sour waterbrash, and epigastric discomfort 1 hour after meals.',
      location: 'Epigastrium and esophagus',
      side: 'Central',
      onset: 'Subacute over 8 months',
      duration: '8 months',
      sensation: 'Burning, sour acid regurgitation reaching the throat with painful bloating',
      aggravatingFactors: '< Spicy oily foods, < Coffee/tea, < Lying down immediately after eating, < Alcohol',
      amelioratingFactors: '> Cold milk, > Warm sips of water, > Sitting upright',
      concomitants: 'Frequent burping with sour taste, nausea in morning, coated tongue',
      ...
      mentalGenerals: 'Irritable, easily angered by contradiction, critical, workaholic',
      ...
      dietaryAdvice: 'Do not lie down for 2 hours post meals. Elevate head of bed by 6 inches. Avoid tea, coffee, and fried snacks.',
      medicineFee: 260.0,
      testCategory: 'Blood / Biochemistry',
      ...
      flag: 'Normal',
      labName: 'Suraksha Diagnostic Lab',
      testNotes: 'Normal liver function. Upper GI endoscopy advised if symptoms persist.',
    ),

    // 8. Eczema & Atopic Dermatitis
    DiseaseArchetype(
      primaryDisease: 'Eczema & Atopic Dermatitis',
      chiefComplaint: 'Dry, lichenified, itchy erythematous patches with peeling and occasional serous oozing on flexures.',
      location: 'Ante-cubital fossae, popliteal fossae, and hands',
      side: 'Bilateral',
      onset: 'Chronic recurrent since 3 years',
      duration: '3 years',
      sensation: 'Intolerable burning itching making the patient scratch until it bleeds',
      aggravatingFactors: '< Night in bed, < Washing with soap/water, < Woolen clothing, < Sweating',
      amelioratingFactors: '> Cool open air, > Gentle stroking, > Dry cool climate',
      ...
      mentalGenerals: 'Philosophical, untidy, dislikes bathing, irritable when disturbed',
      ...
      dietaryAdvice: 'Apply virgin coconut oil locally. Avoid synthetic soaps, eggs, and brinjal. Use cotton clothing.',
      medicineFee: 310.0,
      testCategory: 'Blood / Biochemistry',
      ...
      flag: 'High',
      labName: 'Dr. Lal PathLabs',
      testNotes: 'Markedly elevated total IgE confirming severe atopic dermatitis.',
    ),

    // 9. Renal Calculi (Kidney Stone)
    DiseaseArchetype(
      primaryDisease: 'Renal Calculi (Kidney Stone)',
      chiefComplaint: 'Severe paroxysmal colicky pain in left flank radiating down along ureter to groin with dysuria.',
      ...
      sensation: 'Excruciating sharp cutting, spasming pain with burning micturition',
      aggravatingFactors: '< Motion, < Jarring, < Pressure, < Standing erect',
      amelioratingFactors: '> Lying on painful side, > Warm application, > Passing urine',
      concomitants: 'Nausea, cold clammy sweat, mild microscopic hematuria, urgent desire to urinate',
      ...
      dietaryAdvice: 'Drink 3.5 - 4 liters of filtered water daily. Avoid spinach, tomatoes with seeds, beets, and carbonated beverages.',
      medicineFee: 360.0,
      testCategory: 'Imaging / Radiology',
      testName: 'USG Kidney, Ureter & Bladder (KUB)',
      stringValue: 'Single calculus measuring 5.8 mm in lower third of left ureter with mild hydroureteronephrosis',
      flag: 'Abnormal',
      labName: 'Pulse Diagnostics Lab',
      testNotes: 'Left ureteric calculus suitable for medical expulsion therapy without surgical intervention.',
    ),

    // 10. Sciatica & Lumbar Spondylosis
    DiseaseArchetype(
      primaryDisease: 'Sciatica & Lumbar Spondylosis',
      chiefComplaint: 'Sharp shooting pain from right lower back down posterior thigh to calf and heel with numbness.',
      location: 'L4-L5 lumbar region radiating down right lower limb',
      side: 'Right',
      onset: 'Acute onset after lifting heavy luggage 3 weeks ago',
      duration: '3 weeks',
      sensation: 'Electric shock-like, shooting neuralgic pain with pins-and-needles numbness in right foot',
      aggravatingFactors: '< Forward bending, < Sitting on hard chair, < Coughing/sneezing, < Cold draft',
      amelioratingFactors: '> Lying flat on back with knees flexed, > Hard pressure, > Heat',
      concomitants: 'Stiffness in lower lumbar muscles, inability to lift right leg past 45 degrees',
      causation: 'Mechanical strain leading to L4-L5 disc bulge with nerve root compression',
      ...
      dietaryAdvice: 'Avoid forward bending. Use ergonomic chair and lumbar support pillow. Sleep on firm mattress.',
      medicineFee: 330.0,
      testCategory: 'Imaging / Radiology',
      testName: 'MRI Lumbosacral Spine (L-S Spine)',
      stringValue: 'Posterolateral disc protrusion at L4-L5 causing right exiting L4 and traversing L5 nerve root impingement',
      flag: 'Abnormal',
      labName: 'Peerless Hospital & Diagnostics',
      testNotes: 'Confirmed right-sided L4-L5 radiculopathy with mild canal stenosis.',
    ),

    // 11. Piles & Anal Fissure
    DiseaseArchetype(
      primaryDisease: 'Piles & Anal Fissure',
      chiefComplaint: 'Painful bleeding per rectum during defecation with severe burning pain lasting 2-3 hours after stool.',
      location: 'Anal canal / Rectum',
      side: 'Central',
      onset: 'Subacute 4 months',
      duration: '4 months',
      sensation: 'Sharp cutting like glass shards passing through rectum, fullness like sticks in rectum',
      aggravatingFactors: '< Hard stool, < Straining, < Prolonged sitting, < Spicy food',
      amelioratingFactors: '> Warm sitz bath, > Soft stool, > Lying prone',
      concomitants: 'Chronic constipation, bright red blood dripping into pan after stool',
      ...
      frequency: 'TDS (Three times daily)',
      vehicle: 'Sugar globules No. 30',
      instructions: 'Take 4 globules 30 mins before meals. Take warm sitz bath twice daily.',
      dietaryAdvice: 'High fiber diet with isabgol husk at bedtime. Drink 3 liters of water. Avoid chilies, fried food, and red meat.',
      medicineFee: 310.0,
      testCategory: 'Blood / Biochemistry',
      ...
      flag: 'Low',
      labName: 'Suraksha Diagnostic Lab',
      testNotes: 'Mild normocytic normochromic anemia secondary to chronic rectal blood loss.',
    ),

    // 12. Acne Vulgaris & Dandruff
    DiseaseArchetype(
      primaryDisease: 'Acne Vulgaris & Dandruff',
      chiefComplaint: 'Persistent inflammatory papules, pustules, and dark post-acne blemishes across cheeks and forehead.',
      ...
      aggravatingFactors: '< Oily cosmetics, < Oily junk food, < Premenstrual period, < Humid weather',
      amelioratingFactors: '> Washing face with plain water, > Open cool breeze',
      concomitants: 'Oily greasy facial skin with prominent comedones (blackheads)',
      ...
      mentalGenerals: 'Self-conscious about appearance, low confidence in social interactions',
      miasm: 'Psoro-Sycotic',
      ...
      frequency: 'BD in half cup water',
      vehicle: 'Aqua Distillata',
      instructions: '10 drops orally twice daily. Also apply diluted 1:1 with rosewater externally on blemishes at bedtime.',
      dietaryAdvice: 'Drink 3 liters of water daily. Avoid dairy butter, cheese, chocolates, and oily roadside food.',
      medicineFee: 290.0,
      testCategory: 'Blood / Biochemistry',
      ...
      flag: 'Normal',
      labName: 'Dr. Lal PathLabs',
      testNotes: 'Normal liver biochemistry. Clear skin clearance expected within 8-12 weeks.',
    ),

    // 13. Chronic Bronchial Asthma
    DiseaseArchetype(
      primaryDisease: 'Chronic Bronchial Asthma',
      chiefComplaint: 'Wheezing, chest tightness, and suffocative cough with difficulty in breathing especially at midnight.',
      location: 'Lungs and bronchi',
      side: 'Bilateral',
      onset: 'Recurrent attacks since childhood',
      duration: '6 years chronic',
      sensation: 'Constriction as if chest banded tightly, cannot inhale enough air',
      aggravatingFactors: '< 1 AM - 3 AM, < Cold drinks, < Lying flat on back, < Smoke/fog, < Damp weather',
      amelioratingFactors: '> Sitting upright bending forward, > Warm sips of water, > Expectorating scanty mucus',
      concomitants: 'Loud musical wheeze audible across room, rapid pulse, cold perspiration on forehead',
      causation: 'Allergic hyper-responsiveness triggered by viral infection and cold air',
      ...
      mentalGenerals: 'Extreme restlessness, fear of suffocation and death during acute spasm',
      ...
      frequency: 'TDS (Three times daily)',
      vehicle: 'Sugar globules No. 30',
      instructions: '4 globules TDS. Keep Blatta Q 10 drops in warm water for SOS acute wheezing attacks.',
      dietaryAdvice: 'Avoid refrigerated foods, bananas, ice creams, and cold drinks. Avoid smoke/perfumes.',
      medicineFee: 370.0,
      testCategory: 'Blood / Biochemistry',
      ...
      flag: 'Low',
      labName: 'Apollo Diagnostics Centre',
      testNotes: 'Moderate reversible obstructive airway disease with significant post-bronchodilator response.',
    ),

    // 14. Irritable Bowel Syndrome (IBS)
    DiseaseArchetype(
      primaryDisease: 'Irritable Bowel Syndrome (IBS)',
      chiefComplaint: 'Alternating constipation and diarrhea with lower abdominal cramping immediately after breakfast.',
      location: 'Colon and lower abdomen',
      side: 'Central',
      onset: 'Chronic over 2 years',
      duration: '2 years',
      sensation: 'Cramping griping pain before stool, sensation of incomplete evacuation (never done feeling)',
      aggravatingFactors: '< Morning after breakfast, < Anticipatory anxiety/exams/meetings, < Dairy products',
      amelioratingFactors: '> Passing stool, > Passing flatus, > Warm tea, > Bending double',
      concomitants: 'Excessive rumbling gas in abdomen, irritability, mild hemorrhoidal soreness',
      causation: 'Brain-gut axis dysregulation exacerbated by work stress',
      periodicity: 'Urgent stool call within 15 minutes of first morning tea/meal',
      initialSeverity: 7,
      ...
      mentalGenerals: 'Anxious, anticipatory nervousness before any public event or travel, hurried nature',
      miasm: 'Psoro-Sycotic',
      ...
      dietaryAdvice: 'Follow low-FODMAP diet. Avoid raw salads, whole milk, artificial sweeteners, and caffeine.',
      medicineFee: 300.0,
      testCategory: 'Blood / Biochemistry',
      testName: 'Stool Routine & Occult Blood Examination',
      stringValue: 'No ova, cysts, parasites, or occult blood detected. Mucus present (+)',
      flag: 'Borderline',
      labName: 'Suraksha Diagnostic Lab',
      testNotes: 'Negative for infection or IBD. Consistent with spastic colon / IBS.',
    ),

    // 15. Type 2 Diabetes Mellitus
    DiseaseArchetype(
      primaryDisease: 'Type 2 Diabetes Mellitus',
      chiefComplaint: 'Uncontrolled blood sugars (FBS 178 mg/dL, HbA1c 8.4%) with polyuria at night and burning in soles.',
      location: 'Endocrine system / Peripheral nerves',
      side: 'Bilateral',
      onset: 'Diagnosed 4 years ago, poorly controlled recently',
      duration: '4 years',
      sensation: 'Burning numbness and tingling (stocking-glove neuropathy) in bilateral feet at night',
      aggravatingFactors: '< Night in bed, < Carbohydrate heavy meals, < Sedentary weeks',
      amelioratingFactors: '> Uncovering feet in bed, > Gentle walking in morning',
      concomitants: 'Frequent urination (3-4 times at night), slow wound healing, generalized fatigue',
      ...
      appetite: 'Polyphagia, ravenous hunger with craving for sweets and carbohydrates',
      sleep: 'Broken by nocturia',
      mentalGenerals: 'Depressed about chronic illness, irritable, anxious about vision and kidneys',
      miasm: 'Sycotic / Syphilitic',
      ...
      vehicle: 'Aqua Distillata',
      instructions: '15 drops in half cup water 15 minutes before breakfast, lunch, and dinner.',
      dietaryAdvice: 'Strict diabetic diet. Zero refined sugar, white rice, or potatoes. Daily 45 mins brisk walk.',
      medicineFee: 440.0,
      testCategory: 'Blood / Biochemistry',
      ...
      flag: 'High',
      labName: 'Dr. Lal PathLabs',
      testNotes: 'Uncontrolled glycemic status. Target HbA1c < 7.0%. Fasting blood sugar 178 mg/dL.',
    ),
  ];
}
