            ...
            children: [
              ...
              pw.Table(
                ...
                children: [
                  ...
                  _buildTableRow('Consultation Fee', '₹ ${cashMemo.consultationFee.toStringAsFixed(2)}'),
                  _buildTableRow('Medicine Charges', '₹ ${cashMemo.medicineFee.toStringAsFixed(2)}'),
                  if (cashMemo.otherFee > 0) _buildTableRow('Other Charges', '₹ ${cashMemo.otherFee.toStringAsFixed(2)}'),
                  if (cashMemo.discount > 0) _buildTableRow('Discount (-)', '₹ ${cashMemo.discount.toStringAsFixed(2)}'),
                ],
              ),
              pw.SizedBox(height: 16),
                  ...
                  pw.Container(
                    ...
                    child: pw.Row(
                      ...
                      children: [
                        ...
                        pw.Text('₹ ${cashMemo.total.toStringAsFixed(2)}', style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold, color: primaryColor)),
                      ],
                    ),
                  ),
                ],
