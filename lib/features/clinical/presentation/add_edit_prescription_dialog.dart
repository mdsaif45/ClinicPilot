...
class AddEditPrescriptionDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddEditPrescriptionDialog> createState() =>
      _AddEditPrescriptionDialogState();
}

class _AddEditPrescriptionDialogState
    extends ConsumerState<AddEditPrescriptionDialog> {
  ...
  void initState() {
    ...
    _dietaryController = TextEditingController(text: p?.dietaryAdvice ?? '');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return AppFormDialog(
      title:
          isEditing
              ? 'Edit Remedy (Rx #$_remedyIndex)'
              : 'Prescribe Remedy (Rx #$_remedyIndex)',
      actions: [
        TextButton(
              ...
              children: [
                Expanded(
                  child: DateField(
                    ...
                    onChanged:
                        (date) => setState(() => _prescriptionDate = date),
                  ),
                ),
                ...
                Expanded(
                  child: Builder(
                    builder: (context) {
                      ...
                      final isCustom =
                          !standardOptions.any((o) => o.value == _potency);
                      final options = [
                        ...standardOptions,
                        if (isCustom)
              ...
              children: [
                ...
                Expanded(
                  child: PickerField<String>(
                    ...
                    options: const [
                      PickerOption(
                        value: 'Globules / Pellets',
                        label: 'Globules / Pellets',
                      ),
                      PickerOption(
                        value: 'Mother Tincture in Water',
                        label: 'Drops in Water',
                      ),
                      PickerOption(
                        value: 'Distilled Water / RS',
                        label: 'Liquid in Water',
                      ),
                      PickerOption(
                        value: 'Sugar of Milk / Lactose',
                        label: 'Powder (Lactose)',
                      ),
                    ],
                ...
                Expanded(
                  child: PickerField<String>(
                    ...
                    options: const [
                      ...
                      PickerOption(
                        value: 'BD (Twice daily)',
                        label: 'BD (Twice daily)',
                      ),
                      PickerOption(
                        value: 'TDS (Thrice daily)',
                        label: 'TDS (Thrice daily)',
                      ),
                      PickerOption(
                        value: 'QID (4 times daily)',
                        label: 'QID (4 times daily)',
                      ),
                      PickerOption(
                        value: 'Stat (Immediately)',
                        label: 'Stat (Single dose)',
                      ),
                      PickerOption(
                        value: 'Weekly',
                      ...
                      PickerOption(
                        value: 'Hourly / Fractional',
                        label: 'Hourly / Fractional',
                      ),
                    ],
