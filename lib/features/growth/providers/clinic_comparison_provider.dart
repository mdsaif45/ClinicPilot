...
final clinicComparisonProvider = StreamProvider<List<ClinicMetrics>>((
  ref,
) async* {
  ...
  for (final clinic in clinics) {
    ...
    final priorRevenue = priorMemos.fold<double>(
      0.0,
      (sum, m) => sum + m.total,
    );
    ...
    final variableExpenses = expenses.fold<double>(
      0.0,
      (sum, e) => sum + e.amount,
    );
