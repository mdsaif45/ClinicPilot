...
void main() {
  ...
  group('Database Schema v2 & Business Logic Tests', () {
    ...
    test('Schema v9 includes patient_case_records table', () async {
      final records = await db.select(db.patientCaseRecords).get();
    ...
    test('Schema v11 includes prescriptions table', () async {
      final prescriptions = await db.select(db.prescriptions).get();
      expect(prescriptions, isEmpty);
    });

    test('Schema v12 includes investigations table', () async {
