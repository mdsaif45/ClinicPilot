...
void main() {
  ...
  group('ReferralCrmScreen Widget Tests', () {
    ...
    testWidgets('renders partner card with 3-layer hierarchy and progressive disclosure', (tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            referralContactsProvider.overrideWith((ref) => Stream.value([testPartner])),
          ],
          child: MaterialApp(
            theme: AppTheme.lightTheme,
            home: const ReferralCrmScreen(),
      ...
      expect(find.text('Notes: Active partner referring chronic cases.'), findsOneWidget);
    ...
    testWidgets('responsive layout renders without overflow across compact, standard, and tablet screens', (tester) async {
      ...
      for (final width in [320.0, 360.0, 412.0, 800.0]) {
        ...
        await tester.pumpWidget(
          ProviderScope(
            overrides: [
              referralContactsProvider.overrideWith((ref) => Stream.value(partners)),
            ],
            child: MaterialApp(
              theme: AppTheme.lightTheme,
              home: const ReferralCrmScreen(),
        ...
        expect(find.text('Apex Diagnostic & Pathology Center'), findsOneWidget);
        expect(find.text('Log Visit'), findsOneWidget);
        expect(find.text('+1 Referral'), findsOneWidget);
      }
    });
