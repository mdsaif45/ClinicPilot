...
void main() {
  ...
  group('Dashboard Monthly Snapshot Date Navigation Unit Tests', () {
    test(
      'calculates historical monthly revenue, expense, net profit and patients accurately',
      () async {
            ...
            .insert(
              CashMemosCompanion.insert(
                ...
                memoDate: drift.Value(
                  currentMonth.add(const Duration(days: 5)),
                ),
                total: 5000,
                paymentMethod: 'cash',
              ),
        ...
        container.read(selectedDashboardMonthProvider.notifier).state =
            currentMonth;
  ...
  group('Dashboard Monthly Snapshot Widget Navigation Tests', () {
    testWidgets(
      'navigates to last month with <, advances with >, and restores current month with This Month shortcut',
      (tester) async {
        ...
        // Viewing Last Month
        expect(
          container.read(selectedDashboardMonthProvider).month,
          equals(lastMonth.month),
        );
