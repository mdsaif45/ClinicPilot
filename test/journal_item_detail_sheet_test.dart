...
void main() {
  group('JournalItemDetailSheet Widget Tests', () {
    testWidgets('renders consultation details with hero metrics and patient info', (tester) async {
    ...
    testWidgets('renders invoice details with payment method and amount', (tester) async {
      tester.view.physicalSize = const Size(1200, 2400);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(tester.view.resetPhysicalSize);
      addTearDown(tester.view.resetDevicePixelRatio);
      ...
      expect(find.text('Invoice #CM-2026-00001 • Tariq Mahmood'), findsOneWidget);
