...
void main() {
  ...
  group('PracticeActivityScreen Widget Tests', () {
    testWidgets(
      'renders Day, Week, and Month tabs and switches charts on tap',
      (tester) async {
        ...
        await tester.pump(const Duration(milliseconds: 100));
        expect(
          container.read(activityRangeProvider),
          equals(ActivityTimeRange.week),
        );
        ...
        expect(
          container.read(activityRangeProvider),
          equals(ActivityTimeRange.month),
        );
        ...
        await tester.pump(const Duration(milliseconds: 100));
        expect(
          container.read(activityMetricProvider),
          equals(ActivityMetric.patients),
        );
      },
    );
  });
